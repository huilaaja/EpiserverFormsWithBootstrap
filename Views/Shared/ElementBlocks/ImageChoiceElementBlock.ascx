...
<div class="Form__Element FormChoice FormChoice--Image <%: Model.GetValidationCssClasses() %> form-group row" id="<%: formElement.Guid %>" data-epiforms-element-name="<%: formElement.ElementName %>"
